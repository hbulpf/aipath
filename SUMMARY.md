  ...
  - [PaddleOcr](ocr/paddleocr/README.md)
    ...
    - [PP-OCR](ocr/paddleocr/ppocr_introduction.md)
      ...
      - [前沿算法与模型](ocr/paddleocr/algorithm_overview.md)
        - [文本检测算法](ocr/paddleocr/algorithm_overview.md)
        - [文本识别算法](ocr/paddleocr/algorithm_overview.md)
        - [端到端OCR算法](ocr/paddleocr/algorithm_overview.md)
        - [表格识别算法](ocr/paddleocr/algorithm_overview.md)
        - [关键信息抽取算法](ocr/paddleocr/algorithm_overview.md)
